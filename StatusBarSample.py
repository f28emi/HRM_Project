...
firstsub.add_command(label="Exit",command=root.quit)
firstsub.add_separator()
...
tools=Frame(root,bg="Green")
but1=Button(tools,text="Projects",fg="white",bg="Black")
but1.grid(row=2,column=0)
#but2=Button(tools,text="Structure",fg="white",bg="Black")
#but2.grid(rowspan=6,column=3)
#but3=Button(tools,text="Favorites",fg="white",bg="Black")
#but3.grid(row=20,column=7)
tools.grid(pady=100)

#status=Label(root,text="There is  an Error,Correct It!",bd=2,bg="Blue",fg="White")
